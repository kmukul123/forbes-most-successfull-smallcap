...
describe('Data Service and Normalization Functions', () => {
  ...
  describe('getAmericasData', () => {
    it('should fetch and normalize Americas data correctly', () => {
      ...
      service.getAmericasData().subscribe((data) => {
        expect(data).toEqual(expectedNormalizedData);
      });

      const req = httpMock.expectOne('assets/data/Americas_2025.json');
